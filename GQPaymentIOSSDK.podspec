...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GQPaymentIOSSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/1410avi/GQPaymentIOSSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '1410avi' => 'avinash.soni@grayquest.com' }
  s.source           = { :git => 'https://github.com/1410avi/GQPaymentIOSSDK.git', :tag => s.version.to_s }
